...
namespace TopoCS
{
    class ColorShader
    {
        ...
        public bool Initialize(in Device device)
        {
            return InitializeShader(in device, @"data\color.vs", @"data\color.ps");
        }
    ...
    Matrix projectionMatrix, bool isSecondaryColor = false)
        ...
        private bool InitializeShader(in Device device, string vsFilename, string psFilename)
        {
            try
            {
